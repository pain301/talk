...
import com.pain.dto.SearchLogDto;
import com.pain.exception.ParamException;
import com.pain.mapper.*;
import com.pain.model.*;
...
public class SysLogService {
    ...
    public void saveDeptLog(SysDept before, SysDept after) {
        ...
        sysLog.setType((byte) LogType.TYPE_DEPT);
    ...
    public void saveUserLog(SysUser before, SysUser after) {
        SysLogWithBLOBs sysLog = new SysLogWithBLOBs();
        sysLog.setType((byte) LogType.TYPE_USER);
        sysLog.setTargetId(after == null ? before.getId() : after.getId());
        sysLog.setOldValue(before == null ? "" : JsonMapper.obj2String(before));
        sysLog.setNewValue(after == null ? "" : JsonMapper.obj2String(after));
        sysLog.setOperator(RequestHolder.getCurrentUser().getUsername());
    ...
    public void saveAclModuleLog(SysAclModule before, SysAclModule after) {
        SysLogWithBLOBs sysLog = new SysLogWithBLOBs();
        sysLog.setType((byte) LogType.TYPE_ACL_MODULE);
        sysLog.setTargetId(after == null ? before.getId() : after.getId());
        sysLog.setOldValue(before == null ? "" : JsonMapper.obj2String(before));
        sysLog.setNewValue(after == null ? "" : JsonMapper.obj2String(after));
        sysLog.setOperator(RequestHolder.getCurrentUser().getUsername());
    ...
    public void saveAclLog(SysAcl before, SysAcl after) {
        SysLogWithBLOBs sysLog = new SysLogWithBLOBs();
        sysLog.setType((byte) LogType.TYPE_ACL);
        sysLog.setTargetId(after == null ? before.getId() : after.getId());
        sysLog.setOldValue(before == null ? "" : JsonMapper.obj2String(before));
        sysLog.setNewValue(after == null ? "" : JsonMapper.obj2String(after));
        sysLog.setOperator(RequestHolder.getCurrentUser().getUsername());
    ...
    public void saveRoleLog(SysRole before, SysRole after) {
        SysLogWithBLOBs sysLog = new SysLogWithBLOBs();
        sysLog.setType((byte) LogType.TYPE_ROLE);
        sysLog.setTargetId(after == null ? before.getId() : after.getId());
        sysLog.setOldValue(before == null ? "" : JsonMapper.obj2String(before));
        sysLog.setNewValue(after == null ? "" : JsonMapper.obj2String(after));
        sysLog.setOperator(RequestHolder.getCurrentUser().getUsername());
    ...
    public PageResult<SysLogWithBLOBs> searchPageList(SearchLogVo searchLogVo, PageQuery page) {
        BeanValidator.check(page);
        SearchLogDto dto = new SearchLogDto();

        dto.setType(searchLogVo.getType());
        if (StringUtils.isNotBlank(searchLogVo.getBeforeSeg())) {
            dto.setBeforeSeg("%" + searchLogVo.getBeforeSeg() + "%");
        }
        if (StringUtils.isNotBlank(searchLogVo.getAfterSeg())) {
            dto.setAfterSeg("%" + searchLogVo.getAfterSeg() + "%");
        }
        ...
        try {
            ...
            if (StringUtils.isNotBlank(searchLogVo.getFromTime())) {
                dto.setFromTime(dateFormat.parse(searchLogVo.getFromTime()));
            }
            if (StringUtils.isNotBlank(searchLogVo.getToTime())) {
                dto.setToTime(dateFormat.parse(searchLogVo.getToTime()));
            }
        } catch (Exception e) {
